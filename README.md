...
`words.txt` comes from [tabatkins/wordle-list](https://github.com/tabatkins/wordle-list)  
`answers.txt` comes from [dbraginskiy/wordle](https://github.com/dbraginskiy/wordle)
